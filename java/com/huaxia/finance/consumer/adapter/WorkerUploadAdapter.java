 ...
 */
public class WorkerUploadAdapter extends BaseAdapter{
    private Activity activity;
    private List<String> picList;
    private List bitmapList;
    private OnSelectPicMethod onSelectPicMethod;
    private boolean haveFirst;
    public WorkerUploadAdapter(Activity activity,List<String> picList,List bitmapList,boolean haveFirst,OnSelectPicMethod onSelectPicMethod){
