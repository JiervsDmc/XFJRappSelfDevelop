 ...
 */
public class StudentUploadAdapter extends BaseAdapter{
    private Activity activity;
    private List<String> picList;
    private List bitmapList;
    private OnSelectPicMethod onSelectPicMethod;
    private boolean haveFirst;
    public StudentUploadAdapter(Activity activity,List<String> picList,List bitmapList,boolean haveFirst,OnSelectPicMethod onSelectPicMethod){
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if(position==0) {
            ...
            viewHolder.idCardPositiveUpload.setText("学籍证明");
            viewHolder.tvInformationCategory.setVisibility(View.GONE);
        }else if(position==3) {
            viewHolder.idCardPositiveUpload.setText("商品订单");
            viewHolder.tvInformationCategory.setVisibility(View.GONE);
        } else if(position==4) {
            if(haveFirst){
                viewHolder.tvInformationCategory.setVisibility(View.GONE);
