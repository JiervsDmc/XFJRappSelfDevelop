...
import com.huaxia.finance.consumer.adapter.FreelanceUploadAdapter;
 ...
 * 自由职业者-影像附件上传
 */
public class FreelanceAttachmentUploadActivity extends BaseActivity implements FreelanceUploadAdapter.OnSelectPicMethod, View.OnClickListener {
    ...
    private FreelanceUploadAdapter adapter;
    ...
    protected void setup() {
        ...
        adapter = new FreelanceUploadAdapter(this, list, bitmapList, havePayment, this);
            ...
            public void onResponse(String response, int id) {
                ...
                if (head.getResponseCode().contains("0000")) {
                    if (!IsNullUtils.isNull(body.get("ecmPage"))) {
                        ...
                        ToastUtils.showSafeToast(FreelanceAttachmentUploadActivity.this, head.getResponseMsg());
                        return;
                    }*/
                } else {
                    ToastUtils.showSafeToast(FreelanceAttachmentUploadActivity.this, head.getResponseMsg());
...
//        adapter.notifyDataSetChanged();
    ...
    private void uploadImage(final String file) {
        ...
        ApiCaller.call(this, Constant.URL, "0014", "appService", map, new ApiCaller.MyStringCallback(this, true, false, false, null, null) {
            ...
            public void onResponse(String response, int id) {
                super.onResponse(response, id);
                //请求成功后设置本地图片
                LogUtil.getLogutil().d("上传图片结果"+response);
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case ALLCALL:
                    adapter = new FreelanceUploadAdapter(FreelanceAttachmentUploadActivity.this, list, bitmapList, havePayment, FreelanceAttachmentUploadActivity.this);
                    lvRequiredInformation.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                    break;
    ...
    protected void openGPSSettting(Intent intent) {
        ...
        new AlertDialog.Builder(FreelanceAttachmentUploadActivity.this).setTitle("提示")
