...
import com.huaxia.finance.consumer.adapter.StudentUploadAdapter;
 ...
 * 学生-影像附件上传
 */
public class StudentAttachmentUploadActivity extends BaseActivity implements StudentUploadAdapter.OnSelectPicMethod, View.OnClickListener {
    ...
    protected void setup() {
        ...
        adapter = new StudentUploadAdapter(this, list, bitmapList, havePayment, this);
                ...
                if (head.getResponseCode().contains("0000")) {
                    if (!IsNullUtils.isNull(body.get("ecmPage"))) {
                        ...
                        for (int i = 0; i < ecmPageList.size(); i++) {
                            ...
                            } else if (ecmPageMap.get("classCode").toString().contains("0102")) {
                            ...
                            } else if (ecmPageMap.get("classCode").toString().contains("0105")) {
                        ...
                        ToastUtils.showSafeToast(StudentAttachmentUploadActivity.this, head.getResponseMsg());
                        return;
                    }*/
                } else {
                    ToastUtils.showSafeToast(StudentAttachmentUploadActivity.this, head.getResponseMsg());
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.upload_submit:
                ...
                if (havePayment) {
                    if (list.get(0).equals("1") || list.get(1).equals("1") || list.get(2).equals("1") || list.get(3).equals("1") || list.get(4).equals("1")) {
                        if (bitmapList.get(0).equals("1") || bitmapList.get(1).equals("1") || bitmapList.get(2).equals("1") || bitmapList.get(3).equals("1") || bitmapList.get(4).equals("1")) {
                            if ((list.get(0).equals("1") && bitmapList.get(0).equals("1")) || (list.get(1).equals("1") && bitmapList.get(1).equals("1")) || (list.get(2).equals("1") && bitmapList.get(2).equals("1")) || (list.get(3).equals("1") && bitmapList.get(3).equals("1")) || (list.get(4).equals("1") && bitmapList.get(4).equals("1"))) {
                                toast("请上传必须的影像附件");
                            } else {
...
//        adapter.notifyDataSetChanged();
    ...
    private void uploadImage(final String file) {
        ...
        switch (POSITON) {
            ...
            case 1:
                ...
                break;
            case 2:
                map.put("schoolRoll", s);
                map.put("classCode", "0102");
                break;
            case 3:
                map.put("productOrder", s);
                map.put("classCode", "0105");
                break;
            case 4:
        ...
        ApiCaller.call(this, Constant.URL, "0014", "appService", map, new ApiCaller.MyStringCallback(this, true, false, false, null, null) {
            ...
            public void onResponse(String response, int id) {
                super.onResponse(response, id);
                //请求成功后设置本地图片
                if(head.getResponseCode().equals("0000") && !body.isEmpty()) {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case ALLCALL:
                    adapter = new StudentUploadAdapter(StudentAttachmentUploadActivity.this, list, bitmapList, havePayment, StudentAttachmentUploadActivity.this);
                    lvRequiredInformation.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                    break;
    ...
    protected void openGPSSettting(Intent intent) {
        ...
        toast("请开启GPS");
        new AlertDialog.Builder(StudentAttachmentUploadActivity.this).setTitle("提示")
